...
INPUT_FILE = BASE_DIR / "naver_라벨링_익명화.csv"
...
if not INPUT_FILE.exists():
    raise FileNotFoundError(
        ...
        f"이 파이썬 파일과 같은 폴더에 naver_라벨링_익명화.csv를 넣어 주세요."
    )
...
if not HAS_LABEL:
    raise ValueError(
        ...
        "naver_라벨링_익명화.csv 파일에 manual_label 컬럼과 0/1 라벨이 있는지 확인해 주세요."
    )
